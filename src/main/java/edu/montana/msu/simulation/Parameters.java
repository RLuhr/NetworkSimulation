...
public class Parameters {
	...
	public static final double BROADCASTDISTANCE = 700.00; //meters
    ...
    public static final double DISTANCETODEADZONE = 300;
    public static final double DEADZONEDISTANCE = 1000;
    public static final double TOTALDISTANCE = 2*DISTANCETODEADZONE + DEADZONEDISTANCE;
    ...
    public double TRAFFICCHANCE = HIGHTRAFFIC*TIMESTEP;
